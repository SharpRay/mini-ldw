...
import com.mininglamp.common.DdlException;
import com.mininglamp.common.ErrorCode;
import com.mininglamp.common.ErrorReport;
import com.mininglamp.privilege.LdwAuth;
...
public class MysqlProto {
    ...
    private static boolean authenticate(ConnectContext context, byte[] scramble, byte[] randomString, String qualifiedUser) {
        ...
        if (!LdwAuth.checkPassword(qualifiedUser, remoteIp,
...
//        String qualifiedUser = ClusterNamespace.getFullName(clusterName, tmpUser);
    ...
    private static boolean useLdapAuthenticate(String qualifiedUser) {
        ...
        if (qualifiedUser.equals(LdwAuth.ROOT_USER) || qualifiedUser.equals(LdwAuth.ADMIN_USER)) {
            return false;
        }
