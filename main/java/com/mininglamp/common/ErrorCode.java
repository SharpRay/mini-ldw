...
public enum ErrorCode {
    ...
    ERR_OLTP_DB_CREATE_EXISTS(11007, new byte[] {'H', 'Y', '0', '0', '0'},
            "Can't create oltp database '%s'; database exists"),
    ERR_OLTP_DBACCESS_DENIED_ERROR(11044, new byte[] {'H', 'Y', '0', '0', '0'},
            "Can't create oltp database '%s'; access denied"),
    ERR_OLTP_TABLE_EXISTS_ERROR(11050, new byte[] {'H', 'Y', '0', '0', '0'},
            "Can't create oltp table '%s' in db '%s'; table exists");
